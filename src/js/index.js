...
//   cell1.innerHTML = "<label for='text'>Capability</label><input type='text'>";
//   cell2.innerHTML = "<form><label for='type'>Type</label><select required='' name='capability_commitments' class='capability_commitments'><option value='resource'>Resource</option><option value='competence'>Competence</option><option value='habit' selected=''>Habit</option></select></form>";
//   cell3.innerHTML = "<label for='approach'>Approach</label><input type='text'>";
//   cell4.innerHTML = "<label for='date'>Start date</label><input type='date' class='start' name='trip-start' value='2024-07-26' min='2024-07-26' max='2025-07-26'>";
//   cell5.innerHTML = "<label for='delete'>Delete</label><button class='delete-btn'>Delete</button>";
